    ...
    public static class KNucleotide
{
    ...
    public static void LoadThreeData(Stream inputStream)
    {
    ...
    public static void RunBenchmark(string inputFile, bool output = false)
    {
        tonum['c'] = 1; tonum['C'] = 1;
        tonum['g'] = 2; tonum['G'] = 2;
        tonum['t'] = 3; tonum['T'] = 3;
        ...
        using var inStream = new FileStream(inputFile, FileMode.OpenOrCreate, FileAccess.Read);
        LoadThreeData(inStream);
